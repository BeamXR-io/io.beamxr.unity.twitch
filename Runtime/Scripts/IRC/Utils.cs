...
namespace BeamXR.Streaming.Twitch
{
    ...
    public static class IRCMessageTag
    {
        public static string Read()
        {
            if (Application.isEditor)
            {
                return "<color=#9146ff>[READ]</color>";
            }
            else
            {
                return "[READ]";
        ...
        public static string Write()
        {
            if (Application.isEditor)
            {
                return "<color=#5274ff>[WRITE]</color>";
            }
            else
            {
                return "[WRITE]";
        ...
        public static string Thread()
        {
            if (Application.isEditor)
            {   
                return "<color=#68cca4>[THREAD]</color>";
            }
            else
            {
                return "[THREAD]";
        ...
        public static string Alert()
        {
            if (Application.isEditor)
            {
                return "<color=#ff5252>[ALERT]</color>";
            }
            else
            {
                return "[ALERT]";
